...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    ...
                    <button onclick="window.location.href='<c:url value="ManageAdmin">
                        ...
                        <tbody>
                            <c:forEach var="user" items="${users}">
                                <tr>
                                    ...
                                    <td>
                                        <a href="<c:url value="ManageAdmin">
        ...
        <c:set var = "showEdit" scope = "session" value = "${showEdit}"/>
                    ...
                    <form action="ManageAdmin" method="post">
                        ...
                        <p><label for="role" class="form-label">Role:</label><select name="roleId" id="roleId" class="form-select" >
                            <c:forEach var="roleList" items="${roles}">
                                <c:set var = "id1" scope = "session" value = "${roleList.roleId}"/>
                                <c:set var = "id2" scope = "session" value = "${user.role.roleId}"/>
                                <option value="${roleList.roleId}"  <c:if test = "${ (id1 == id2) }"> selected </c:if> >${roleList.roleName}</option>
            ...
            <div class="row">
                <div class="col-4">
                    ...
                    <form action="ManageAdmin" method="post">
                        ...
                        <input type="hidden" id="action2" name="action" value="add">
